  ...
  <Collapsible v-model:open="isOpen" class="border border-gray-200 rounded-lg bg-white mb-4">
    <CollapsibleTrigger class="flex items-center justify-between w-full p-3 hover:bg-gray-50 rounded-lg">
      <div class="flex items-center gap-2">
        ...
        <span class="font-medium text-sm">How to use AMR detection</span>
      </div>
      <ChevronDown
      ...
      <Tabs default-value="overview" class="mt-2">
        ...
        <div class="mt-3 text-sm text-gray-600 max-h-64 overflow-y-auto">
          <TabsContent value="overview" class="space-y-4">
            <p>
              Upload one assembled genome FASTA file to scan for AMR report units with the bundled AMRFinderPlus k-mer index.
            </p>
          </TabsContent>
          ...
          <TabsContent value="parameters">
            <dl class="space-y-3">
              <div>
                <dt class="font-medium text-gray-900">Minimum exact-gene fraction</dt>
...
export default defineComponent({
  name: "AMRDetectionHelpCollapsible",
  components: {
    HelpCircle,
    ChevronDown,
    Collapsible,
