...
impl Correctable for PtGraph {
    ...
    fn correct_bubbles(&mut self) -> bool {
        ...
        logw(format!("Bubble correction ended. Corrected graph has {} nodes and {} edges",
              self.graph.node_count(),
              self.graph.edge_count()).as_str(), Some("info"));
    ...
    fn remove_dead_paths(&mut self) -> bool {
        logw(format!("Before pruning: {} nodes and {} edges",
            self.graph.node_count(),
            self.graph.edge_count()).as_str(), Some("info"));
        ...
        loop {
            ...
            logw(format!("Detected {} externals", externals.len()).as_str(), Some("trace"));
